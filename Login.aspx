<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Login2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <div class="container">
     ...
     <div class="row">
      ...
      <div class="col">
          ...
          <div class="row">
              <div class="col">
                  <br />
               <center> <h3 style="font-family:'Adobe Gothic Std'">WELCOME USER</h3></center> 
              </div>
          </div>
     ...
     <br />
           ...
           <center> <a href="ForgotPassword.aspx" style="font-size:medium">Forgot Password?</a></center>
